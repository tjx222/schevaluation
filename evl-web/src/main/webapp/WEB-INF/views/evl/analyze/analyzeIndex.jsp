...
<html>
<head>
<ui:htmlHeader title="分析报告"></ui:htmlHeader><link rel="stylesheet" href="${ctxStatic }/modules/evl/css/index.css" media="screen">
</head>
<body>
	<div class="jyyl_top">
	<ui:tchTop modelName="分析报告"></ui:tchTop>
	</div>
	<div class="jyyl_nav">
		当前位置：
	...
	<div class="flow_chart_wrap">
		<div class="flow_chart_wrap_left">
			<ul>
				...
				<li><a href="${ctx}jy/evl/analyze/analyzeIndex"
					class="f_c_w_l_act">分析报告</a></li>
	...
	<script type="text/javascript">
		$(function() {
			...
			function bindSchoolYearListInfo(showDiv, schoolYear) {
				var url = "${ctx}/jy/evl/analyze/findAnalyzeQuestionnairesList";
				$.post(url, {
						...
						.click(
								function() {
									var questionnairesId = $(this).attr(
											"data-id");
									location.href = "${ctx}/jy/evl/analyze/analyzeInfo?questionnairesId="
											+ questionnairesId;
								});
			}
