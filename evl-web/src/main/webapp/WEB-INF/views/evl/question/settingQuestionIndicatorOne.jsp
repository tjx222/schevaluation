...
<body>
	...
	<div id="two_indicators_del_dialog" class="dialog">
		<div class="dialog_wrap">
			...
			<div class="dialog_content">
				<div class="del_info" style="width: 240px;">
					<span></span> 
					<strong style="width: 190px;line-height:34px;">您确定要删除此二级指标吗？</strong>
				</div>
	...
	<div id="two_indicators_edit_dialog" class="dialog">
		<div class="dialog_wrap">
			...
			<div class="dialog_content">
				<div class="add_two_level edit_one_level">
					<div class="one_name">
						<label for=""><span>*</span>二级指标：</label>
				...
				<div class="d_q_content">
					...
					<div class="d_q_content_txt">
						<div class="d_q_content_one">
							<a></a> <strong>总分已设定为100分，为使各项评价指标所占权重更为合理，请您设置各指标分数。</strong> <input
								type="button" class="score_calculation" value="分数核算" />
						</div>
...
function initindicatorDom(questionnairesId){
	...
	bindClickEvent();
	$("#indicator_result_content tr th").last().css({"border-right":"none"});
}
...
function showOneIndicatorAdd(indicator){
	...
	//评教结果
	showIndicatorResult(indicator,'oneAdd');//显示评教结果
	changedom_height();
...
// 		</c:forEach>
	...
	var htmlStr = 
		...
		+indicator.id
		+'">' + _tds + '</tr>';
	if(leftheight=='oneAdd'){
		$(".tr_right_one").before(htmlStr);
	}else{
...
//     		  alert("请选择一个问卷！");
   ...
   function savecallback(data){
	...
	function checkOneForm(formId,scoredom){
