...
public class UserDaoImpl extends AbstractDAO<User,Integer> implements UserDao {
	 ...
	 * @param userIds
	 * @return
	 * @see com.mainbo.jy.uc.dao.UserDao#findByIds(java.util.List)
	 */
	@Override
	 ...
	 * 通过机构ID查询出用户登录信息
	 * @param orgId
	 * @see com.mainbo.jy.uc.dao.UserDao#findUserInfosByOrgId(java.lang.Integer)
	 */
	@Override
	 ...
	 * @param userType
	 * @return
	 * @see com.mainbo.jy.uc.dao.UserDao#findUserInfosByUserType(java.lang.Integer)
	 */
	@Override
