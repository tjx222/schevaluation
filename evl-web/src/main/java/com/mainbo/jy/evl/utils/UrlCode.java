...
import com.mainbo.jy.utils.Encodes;
public class UrlCode {
	
	public static void main(String[] args) {
		EvlLoginTag tag=new EvlLoginTag();
		EvlQuestionnaires questionnaire=new EvlQuestionnaires();
		questionnaire.setQuestionnairesId(1);
		//tag.setQuestionnaire(questionnaire);
		tag.setQuestionnairesId(4);
		tag.setOrgId(4);
		tag.setStudentId(4);
		//tag.setStudentAccount(studentAccount);
		String params=JSON.toJSONString(tag);
		String encodeParams=Encodes.encodeBase64(params.getBytes());
		String sLongUrl="http://localhost/kpi-web/jy/evl/operate/?params="+encodeParams;
