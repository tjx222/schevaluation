 ...
 */
package com.tmser.schevaluation.uc.listenner;
...
public class DefaultLoginSuccesssListenner implements LoginSuccessListenner{
	 ...
	 * 登录监听器
	 * @param login
	 * @see com.tmser.schevaluation.uc.listenner.LoginSuccessListenner#doOnSuccess(com.tmser.schevaluation.uc.bo.Login)
	 */
	@Override
