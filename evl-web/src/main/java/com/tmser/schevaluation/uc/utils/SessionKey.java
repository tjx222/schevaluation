 ...
 */
package com.tmser.schevaluation.uc.utils;
...
public abstract class SessionKey {
	...
	* 当前用户所在机构
	*/
	public static final String CURRENT_ORGANIZATION = "_CURRENT_ORGANIZATION_";
	...
	public static final String EVL_OPERATETYPE = "operate_type";
