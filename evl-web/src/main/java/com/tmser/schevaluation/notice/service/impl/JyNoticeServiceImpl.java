 ...
 */
package com.tmser.schevaluation.notice.service.impl;
...
import com.tmser.schevaluation.notice.bo.JyNotice;
import com.tmser.schevaluation.notice.constants.JyNoticeConstants;
import com.tmser.schevaluation.notice.dao.JyNoticeDao;
import com.tmser.schevaluation.notice.service.JyNoticeService;
import com.tmser.schevaluation.notice.service.bo.MessageNumCacheEntity;
import com.tmser.schevaluation.uc.utils.CurrentUserContext;
import com.tmser.schevaluation.utils.JyAssert;
...
@Service
@Transactional
public class JyNoticeServiceImpl extends AbstractService<JyNotice, Long>
    implements JyNoticeService {
  ...
  public static final String defaultLink = "jy_front_url";
   ...
   * 
   * @param notice
   * @see com.tmser.schevaluation.notice.service.JyNoticeService#addNotice(com.tmser.schevaluation.notice.bo.JyNotice)
   */
  @Override
  public void addNotice(JyNotice notice) {
    // 校验通知
    checkNotice(notice);
    notice.setReceiverState(notice.getReceiverState() == null
        ? JyNoticeConstants.RECIEVER_STATE_UNREAD : notice.getReceiverState());
    notice.setSenderState(notice.getSendDate() == null
        ? JyNoticeConstants.SEND_STATE_UNDELETE : notice.getSenderState());
   ...
   * 
   * @param notice
   * @see com.tmser.schevaluation.notice.service.JyNoticeService#readNotice(com.tmser.schevaluation.notice.bo.JyNotice)
   */
  @Override
  public void readNotice(Long noticeId) {
    ...
    notice.addCustomCondition("and receiverState=0",
    ...
    if (update == 1) {
      ...
      // 未读通知减1
      if (valueWrapper != null) {
        MessageNumCacheEntity entry = (MessageNumCacheEntity) valueWrapper
            .get();
        if (entry != null)
          entry.increaseNotice(-1);
      }
   ...
   * @param noticeId
   * @return
   * @see com.tmser.schevaluation.notice.service.JyNoticeService#getNextNotice(java.lang.Long)
   */
  @Override
  public JyNotice getNextNotice(Long noticeId, Integer receiverState) {
    return jyNoticeDao.getNextNotice(noticeId, receiverState,
   ...
   * @param noticeId
   * @return
   * @see com.tmser.schevaluation.notice.service.JyNoticeService#getPreNotice(java.lang.Long)
   */
  @Override
  public JyNotice getPreNotice(Long noticeId, Integer receiverState) {
    return jyNoticeDao.getPreNotice(noticeId, receiverState,
        CurrentUserContext.getCurrentUserId());
  }
   ...
   * 
   * @param ids
   * @see com.tmser.schevaluation.notice.service.JyNoticeService#delteNotices(java.util.List)
   */
  @Override
