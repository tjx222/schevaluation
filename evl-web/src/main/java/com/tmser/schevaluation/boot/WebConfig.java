...
import com.tmser.schevaluation.common.web.json.FastJsonJsonWithFilterView;
import com.tmser.schevaluation.common.web.json.FastJsonWithFilterHttpMessageConverter;
import com.tmser.schevaluation.common.web.json.JsonpWithFilterView;
import com.tmser.schevaluation.common.web.json.PageJsonFilter;
...
@EnableWebMvc
@ComponentScan(basePackages = "com.tmser.schevaluation.**.controller", useDefaultFilters = false, includeFilters = @Filter(Controller.class), lazyInit = true)
