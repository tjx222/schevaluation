...
import com.tmser.schevaluation.common.orm.parse.OrmNameReplacement;
import com.tmser.schevaluation.common.orm.parse.TablesNameMapFinder;
...
public class DefaultSqlMapping implements SqlMapping,InitializingBean{
	...
	public String mapping(String sql){
		...
		logger.info("need parse sql is [{}]",sql);
		Statement statement;
		try {
		...
		try{
			...
			logger.info("sql parse result is [{}]",buffer);
