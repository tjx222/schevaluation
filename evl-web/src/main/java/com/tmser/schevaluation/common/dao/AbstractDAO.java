package com.tmser.schevaluation.common.dao;
...
import com.tmser.schevaluation.common.bo.QueryObject.NamedConditon;
import com.tmser.schevaluation.common.orm.Column;
import com.tmser.schevaluation.common.orm.DefaultMapperCreater;
import com.tmser.schevaluation.common.orm.MapperAware;
import com.tmser.schevaluation.common.orm.MapperContainer;
import com.tmser.schevaluation.common.orm.MapperCreater;
import com.tmser.schevaluation.common.orm.SqlMapping;
import com.tmser.schevaluation.common.orm.Table;
import com.tmser.schevaluation.common.orm.ValidateAbleSqlParameterSource;
import com.tmser.schevaluation.common.page.Page;
import com.tmser.schevaluation.common.page.PageList;
import com.tmser.schevaluation.common.page.PageUtil;
...
public abstract class AbstractDAO<E extends QueryObject, K extends Serializable>
	...
	public PageList<E> listPage(E model) {
		...
		logger.info("sql:{},param:{}",sql,paramMap);
	 ...
	 * @param model
	 * @return
	 * @see com.tmser.schevaluation.common.dao.BaseDAO#findOne(java.lang.Object)
	 */
	@Override
