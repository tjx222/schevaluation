...
public class EvlOperateResultServiceImpl extends AbstractService<EvlOperateResult, String> implements EvlOperateResultService {
	 ...
	 * @param eq
	 * @return
	 * @see com.tmser.schevaluation.evl.service.EvlOperateResultService#findAnalyzeIndicatorList(com.tmser.schevaluation.evl.bo.EvlQuestionnaires)
	 */
	@Override
	...
	/**
	 * @param rs
	 * @see com.tmser.schevaluation.evl.service.EvlOperateResultService#saveOrUpdateResult(com.tmser.schevaluation.evl.bo.EvlOperateResult)
	 */
	@Override
