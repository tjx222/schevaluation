...
public class EvlStudentAccountDaoImpl extends AbstractDAO<EvlStudentAccount,String> implements EvlStudentAccountDao {
	 ...
	 * @param model
	 * @return
	 * @see com.tmser.schevaluation.common.dao.AbstractDAO#listAll(com.tmser.schevaluation.common.bo.QueryObject)
	 */
	@Override
	 ...
	 * @param classModel
	 * @return
	 * @see com.tmser.schevaluation.evl.dao.EvlStudentAccountDao#listPage(com.tmser.schevaluation.evl.bo.EvlStudentAccount, com.tmser.schevaluation.evl.bo.ClassStudent)
	 */
	@Override
